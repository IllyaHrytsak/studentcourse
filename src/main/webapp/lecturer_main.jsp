...
<meta http-equiv="content-type" content="text/html; charset=utf-8">
    ...
    <hr/>
        ...
        <form name="loginForm" method="POST" action="/">
            ...
            <c:out value="${fullNameValue}: [${studentNameMark} ${studentSurnameMark}]
                          ${markValue}: [${mark}]"/>
            <hr/>
        </form>
            <c:forEach items="${students}" var="student">
                <form name="showMarkForm" method="POST" action="/">
                    ...
                    <fmt:message key="main.button.show_mark" var="showMarkValue" />
                    <input type ="submit" value="${showMarkValue}">
                </form>
